...
////// Pelicans //////
	...
	class SEC_OLDTRE_Pelican: VES_D77HTCI_A // Currently used as a Stealth Pelican.
	{
		...
		faction="SEC_Faction_Main";
		editorsubcategory="SEC_Categ_Vic_Rotary";
		displayName="[SEC] D77S-TCI/AV Pelican (Stealth)";
		memoryPointDriverOptics="machinegun_eject_dir";
			...
			class TransportPylonsComponent
			{
				...
				class pylons
				{
					class pylons1
					{
						...
						attachment="SEC_PylonRack_3Rnd_Cinquedea";
						bay=-1;
						priority=2;
						UIposition[]={0.1,0.5};
						turret[]={};
		...
		class Turrets: Turrets
		{
			class CopilotTurret: CopilotTurret
			{
				...
				class OpticsIn
				{
					...
					class Narrower: Wide
					{
						initFov=0.0048333333333333;
						minFov=0.0048333333333333;
						maxFov=0.0048333333333333;

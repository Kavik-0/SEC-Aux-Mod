...
class CfgWeapons
{
	...
	class IMS_ForceEdge: WBK_pipeStyledSword
	{
		displayName="[WSD] Force Edge"; //// Name of the weapon
		model="MeleeWeapons\forceedge.p3d"; //// Path to your model
		IMS_Melee_Param_Damage = 0.35; //// Your melee weapon damage (Notice that this param is multiplied by engine in a way that 0.2 will become 40. So this weapon deals 40 hp damage. 0.25 will deal 50 damage.
		
		IMS_Melee_Param_Sounds="[""machete_swing_miss1"",""machete_swing_miss2""]";
		...
		IMS_WeaponType = "TwoHanded"; //// that's what define which moveset your weapon will use.
